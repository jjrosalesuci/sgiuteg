...
use Yii;
use app\modules\mod_contable\models\NotifContab;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class NotifcontabController extends \yii\web\Controller
{
    ...
    public function actionCargarnotifcontab()
    {
        ...
        $count = NotifContab::find()->where(['modulo' => "Saldos"])->count();
        $query = NotifContab::find()->where(['modulo' => "Saldos"]);
    ...
    {
        if (($model = NotifContab::findOne($id)) !== null) {
            return $model;
        } else {
